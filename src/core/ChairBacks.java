...
public class ChairBacks implements ThingInterface {
    private String name;
    private String nameVPredlojnomPadeje;

    public ChairBacks(){
        name = "спинки стульев";
        nameVPredlojnomPadeje = "спинках стульев";
    }

    public ChairBacks(String name, String nameVPredlojnomPadeje){
        this.name = name;
    ...
    public String toString(){
        return "Это класс про Спинки стульев (на них должна быть одежда)";
    }
}
