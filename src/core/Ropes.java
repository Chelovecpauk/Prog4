...
public class Ropes implements ThingInterface {
    private String name;
    private String nameVPredlojnomPadeje;

    public Ropes(){
        name = "верёвочки";
        nameVPredlojnomPadeje = "веревочках";
    }

    public Ropes(String name, String nameVPredlojnomPadeje){
        this.name = name;
    ...
    public String toString(){
        return "Это класс про веревочки";
    }
}
